<?php get_header(); ?>
    ...
    <section id="content">
      ...
      <?php if(!is_single() && is_home() && function_exists('wpp_get_mostpopular') && get_theme_mod( 'wpdev_show_header_popular_posts')) : ?>
        <?php wpp_get_mostpopular([
          'wpp_start' => '<div class="section header-stick bottommargin-lg clearfix" style="padding: 20px 0;">
          <div>
            <div class="container clearfix">
              <span class="badge badge-danger bnews-title">' . get_theme_mod( 'wpdev_popular_posts_widget_title' ) . '</span>
